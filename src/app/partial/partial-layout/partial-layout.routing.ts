...
export const PartialLayoutRoutes: Routes = [
  ...
  { path: 'grievance-master', loadChildren: () => import('../../partial/grievance-master/grievance-master.module').then(m => m.GrievanceMasterModule), data: { title: 'Grivance Master' }, canActivate: [ExpenseGuard] },
  { path: 'post-grievance', loadChildren: () => import('../../partial/post-grievance/post-grievance.module').then(m => m.PostGrievanceModule), data: { title: 'Post Grivance' }, canActivate: [ExpenseGuard] },
