...
export const PartialLayoutRoutes: Routes = [
  ...
  { path: 'department-master', loadChildren: () => import('../../partial/department-master/department-master.module').then(m => m.DepartmentMasterModule),data: { breadcrumb: [{ title: 'Department Master', active: true }]}, canActivate: [ExpenseGuard] },
