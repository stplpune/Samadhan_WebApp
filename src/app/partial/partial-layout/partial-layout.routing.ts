...
export const PartialLayoutRoutes: Routes = [
  ...
  { path: 'collector-references', loadChildren: () => import('../../partial/post-grievance/post-grievance.module').then(m => m.PostGrievanceModule), data: { title: 'Post Grievance' }, canActivate: [ExpenseGuard] },
